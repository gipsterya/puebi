...
<b>II.B.1.</b> Imbuhan (awalan, sisipan, akhiran, serta gabungan awalan dan akhiran) ditulis serangkai dengan bentuk dasarnya.
</div>
<br />
...
<div style={{ padding: '20px', color: 'black', backgroundColor: '#dbfaf4' }}>
<b>II.B.2.</b> Bentuk terikat ditulis serangkai dengan kata yang mengikutinya.
</div>
<br />
